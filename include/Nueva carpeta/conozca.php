...
$t = new TemplatePower("conozca.html");
$t->prepare();
...
$db->query("SELECT INGE_TITULO,INGE_CUERPO FROM CONOSCA_INGELUBE WHERE INGE_ID=1");
$db->next_record(); 

$t->assign("titulo",$db->Record['INGE_TITULO']);
$t->assign("cuerpo",str_replace("\n", "<br>", $db->Record['INGE_CUERPO']));
