...
class c_menu extends cTable {
	...
	function __construct() {
		...
		// men_id
		$this->men_id = new cField('_menu', 'menu', 'x_men_id', 'men_id', '`men_id`', '`men_id`', 3, -1, FALSE, '`men_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function DeleteSQL(&$rs, $where = "") {
		...
		if ($rs) {
			$sql .= ew_QuotedName('men_id') . '=' . ew_QuotedValue($rs['men_id'], $this->men_id->FldDataType) . ' AND ';
		}
	...
	function SqlKeyFilter() {
		return "`men_id` = @men_id@";
	}

	// Key filter
	function KeyFilter() {
		$sKeyFilter = $this->SqlKeyFilter();
		if (!is_numeric($this->men_id->CurrentValue))
			$sKeyFilter = "0=1"; // Invalid key
		$sKeyFilter = str_replace("@men_id@", ew_AdjustSql($this->men_id->CurrentValue), $sKeyFilter); // Replace key value
		return $sKeyFilter;
	}
	...
	// View URL
	function GetViewUrl() {
		return $this->KeyUrl("_menuview.php", $this->UrlParm());
	}
	...
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("_menuedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("_menuadd.php", $this->UrlParm($parm));
	}
	...
	function KeyUrl($url, $parm = "") {
		$sUrl = $url . "?";
		if ($parm <> "") $sUrl .= $parm . "&";
		if (!is_null($this->men_id->CurrentValue)) {
			$sUrl .= "men_id=" . urlencode($this->men_id->CurrentValue);
		} else {
