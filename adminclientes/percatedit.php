...
fpercatedit.Lists["x_per_id"] = {"LinkField":"x_per_id","Ajax":null,"AutoFill":false,"DisplayFields":["x_per_nombre","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<script type="text/javascript">
fpercatedit.Lists["x_per_id"].Options = <?php echo (is_array($percat->per_id->EditValue)) ? ew_ArrayToJson($percat->per_id->EditValue, 1) : "[]" ?>;
</script>
