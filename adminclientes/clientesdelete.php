...
?>
<p><span id="ewPageCaption" class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Delete") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $clientes->TableCaption() ?></span></p>
<p class="phpmaker"><a href="<?php echo $clientes->getReturnUrl() ?>" id="a_GoBack" class="ewLink"><?php echo $Language->Phrase("GoBack") ?></a></p>
<?php $clientes_delete->ShowPageHeader(); ?>
<?php
$clientes_delete->ShowMessage();
?>
<form name="fclientesdelete" id="fclientesdelete" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<br>
...
<table id="tbl_clientesdelete" class="ewTable ewTableSeparate">
<?php echo $clientes->TableCustomInnerHtml ?>
	<thead>
	<tr class="ewTableHeader">
		<td><span id="elh_clientes_id" class="clientes_id"><table class="ewTableHeaderBtn"><tr><td><?php echo $clientes->id->FldCaption() ?></td></tr></table></span></td>
		<td><span id="elh_clientes_nombre" class="clientes_nombre"><table class="ewTableHeaderBtn"><tr><td><?php echo $clientes->nombre->FldCaption() ?></td></tr></table></span></td>
		<td><span id="elh_clientes_mailsalerta" class="clientes_mailsalerta"><table class="ewTableHeaderBtn"><tr><td><?php echo $clientes->mailsalerta->FldCaption() ?></td></tr></table></span></td>
	</tr>
	</thead>
	<tbody>
<?php
...
?>
	<tr<?php echo $clientes->RowAttributes() ?>>
		<td<?php echo $clientes->id->CellAttributes() ?>><span id="el<?php echo $clientes_delete->RowCnt ?>_clientes_id" class="clientes_id">
<span<?php echo $clientes->id->ViewAttributes() ?>>
<?php echo $clientes->id->ListViewValue() ?></span>
</span></td>
		<td<?php echo $clientes->nombre->CellAttributes() ?>><span id="el<?php echo $clientes_delete->RowCnt ?>_clientes_nombre" class="clientes_nombre">
<span<?php echo $clientes->nombre->ViewAttributes() ?>>
<?php echo $clientes->nombre->ListViewValue() ?></span>
</span></td>
		<td<?php echo $clientes->mailsalerta->CellAttributes() ?>><span id="el<?php echo $clientes_delete->RowCnt ?>_clientes_mailsalerta" class="clientes_mailsalerta">
