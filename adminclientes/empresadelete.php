...
$empresa_delete = NULL; // Initialize page object first

class cempresa_delete extends cempresa {
...
// Create page object
if (!isset($empresa_delete)) $empresa_delete = new cempresa_delete();
...
// Form object
var fempresadelete = new ew_Form("fempresadelete");

// Form_CustomValidate event
fempresadelete.Form_CustomValidate = 
...
fempresadelete.ValidateRequired = true;
<?php } else { ?>
fempresadelete.ValidateRequired = false; 
<?php } ?>
...
?>
<p><span id="ewPageCaption" class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Delete") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $empresa->TableCaption() ?></span></p>
...
?>
<form name="fempresadelete" id="fempresadelete" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<br>
...
<table id="tbl_empresadelete" class="ewTable ewTableSeparate">
<?php echo $empresa->TableCustomInnerHtml ?>
	<thead>
	<tr class="ewTableHeader">
		<td><span id="elh_empresa_emp_id" class="empresa_emp_id"><table class="ewTableHeaderBtn"><tr><td><?php echo $empresa->emp_id->FldCaption() ?></td></tr></table></span></td>
		<td><span id="elh_empresa_emp_nombre" class="empresa_emp_nombre"><table class="ewTableHeaderBtn"><tr><td><?php echo $empresa->emp_nombre->FldCaption() ?></td></tr></table></span></td>
	</tr>
	</thead>
	<tbody>
<?php
...
?>
	<tr<?php echo $empresa->RowAttributes() ?>>
		<td<?php echo $empresa->emp_id->CellAttributes() ?>><span id="el<?php echo $empresa_delete->RowCnt ?>_empresa_emp_id" class="empresa_emp_id">
<span<?php echo $empresa->emp_id->ViewAttributes() ?>>
<?php echo $empresa->emp_id->ListViewValue() ?></span>
</span></td>
		<td<?php echo $empresa->emp_nombre->CellAttributes() ?>><span id="el<?php echo $empresa_delete->RowCnt ?>_empresa_emp_nombre" class="empresa_emp_nombre">
