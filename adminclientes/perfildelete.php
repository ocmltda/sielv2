...
// Page object
var perfil_delete = new ew_Page("perfil_delete");
perfil_delete.PageID = "delete"; // Page ID
var EW_PAGE_ID = perfil_delete.PageID; // For backward compatibility

// Form object
var fperfildelete = new ew_Form("fperfildelete");
...
?>
<p><span id="ewPageCaption" class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Delete") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $perfil->TableCaption() ?></span></p>
...
?>
<form name="fperfildelete" id="fperfildelete" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<br>
...
<table id="tbl_perfildelete" class="ewTable ewTableSeparate">
<?php echo $perfil->TableCustomInnerHtml ?>
	<thead>
	<tr class="ewTableHeader">
		<td><span id="elh_perfil_per_id" class="perfil_per_id"><table class="ewTableHeaderBtn"><tr><td><?php echo $perfil->per_id->FldCaption() ?></td></tr></table></span></td>
		<td><span id="elh_perfil_per_nombre" class="perfil_per_nombre"><table class="ewTableHeaderBtn"><tr><td><?php echo $perfil->per_nombre->FldCaption() ?></td></tr></table></span></td>
	</tr>
	</thead>
	<tbody>
<?php
...
?>
	<tr<?php echo $perfil->RowAttributes() ?>>
		<td<?php echo $perfil->per_id->CellAttributes() ?>><span id="el<?php echo $perfil_delete->RowCnt ?>_perfil_per_id" class="perfil_per_id">
<span<?php echo $perfil->per_id->ViewAttributes() ?>>
<?php echo $perfil->per_id->ListViewValue() ?></span>
</span></td>
		<td<?php echo $perfil->per_nombre->CellAttributes() ?>><span id="el<?php echo $perfil_delete->RowCnt ?>_perfil_per_nombre" class="perfil_per_nombre">
