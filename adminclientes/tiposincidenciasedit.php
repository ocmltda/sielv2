...
$tiposincidencias_edit = NULL; // Initialize page object first

class ctiposincidencias_edit extends ctiposincidencias {
	...
	// Page object name
	var $PageObjName = 'tiposincidencias_edit';
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->tipi_id->CurrentValue == "")
			$this->Page_Terminate("tiposincidenciaslist.php"); // Invalid key, return to list
	...
	function LoadFormValues() {
		...
		// Load from form
		global $objForm;
		if (!$this->tipi_id->FldIsDetailKey)
			$this->tipi_id->setFormValue($objForm->GetValue("x_tipi_id"));
	...
	function RenderRow() {
		...
		if ($this->RowType == EW_ROWTYPE_VIEW) { // View row
			...
			$this->tipi_id->EditValue = $this->tipi_id->CurrentValue;
			$this->tipi_id->ViewCustomAttributes = "";
...
// Create page object
if (!isset($tiposincidencias_edit)) $tiposincidencias_edit = new ctiposincidencias_edit();

// Page init
$tiposincidencias_edit->Page_Init();

// Page main
$tiposincidencias_edit->Page_Main();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var tiposincidencias_edit = new ew_Page("tiposincidencias_edit");
tiposincidencias_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = tiposincidencias_edit.PageID; // For backward compatibility

// Form object
var ftiposincidenciasedit = new ew_Form("ftiposincidenciasedit");

// Validate form
ftiposincidenciasedit.Validate = function(fobj) {
...
ftiposincidenciasedit.Form_CustomValidate = 
...
ftiposincidenciasedit.ValidateRequired = true;
<?php } else { ?>
ftiposincidenciasedit.ValidateRequired = false; 
<?php } ?>
...
<p><span id="ewPageCaption" class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Edit") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $tiposincidencias->TableCaption() ?></span></p>
...
<?php $tiposincidencias_edit->ShowPageHeader(); ?>
<?php
$tiposincidencias_edit->ShowMessage();
?>
<form name="ftiposincidenciasedit" id="ftiposincidenciasedit" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return ewForms[this.id].Submit();">
<br>
<input type="hidden" name="t" value="tiposincidencias">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table id="tbl_tiposincidenciasedit" class="ewTable">
...
<?php echo $tiposincidencias->tipi_id->EditValue ?></span>
<input type="hidden" name="x_tipi_id" id="x_tipi_id" value="<?php echo ew_HtmlEncode($tiposincidencias->tipi_id->CurrentValue) ?>">
</span><?php echo $tiposincidencias->tipi_id->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
ftiposincidenciasedit.Init();
</script>
<?php
$tiposincidencias_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$tiposincidencias_edit->Page_Terminate();
?>
