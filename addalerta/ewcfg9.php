...
define("EW_PROJECT_NAME", "alertas", TRUE); // Project name
...
define("EW_RANDOM_KEY", 'ZEnzJ0MytLQLQ5Ze', TRUE); // Random key for encryption
...
define("EW_FILE_SYSTEM_ENCODING", "utf-8", TRUE); // File system encoding
